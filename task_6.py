...
password = 'hastylkhopnbhlqv' # temprory gmail password don't share with any one remove this line 
username = 'souravkumarroy007@gmail.com' 

send_to = 'souravkumarroy007@gmail.com'
send_by = 'souravkumarroy007@gmail.com'
...
contact_number = '+917749980253'
message = 'Welcome Back'

# model parameter
model_to_use = 'sourav.xml'
...
def send_whatsapp():
    ...
    hr, minu, _ = str(a).split(' ')[1].split(':')
    pywhatkit.sendwhatmsg(contact_number, message, int(hr), int(minu) + 2)


def create_ec2():

    ec2 = json.loads(subprocess.getoutput('aws ec2 run-instances --image-id ami-0ad704c126371a549 --instance-type t2.micro --subnet-id subnet-aed03bc5'))
...
sourav_model = cv2.face_LBPHFaceRecognizer.create()
sourav_model.read('sourav.xml')
...
while True:
    ...
    try:
        ...
        results = sourav_model.predict(face)
